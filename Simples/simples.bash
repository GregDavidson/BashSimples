...
# This is a port of the simples package developed for the Bourne Shell,
# This port should run properly under Bash.
...
simple_join() {
    local -r delim="$1" ; shift
    (( $# )) || return
    local accum="$1" ; shift
    local word ; for word; do
      accum="${accum}${delim}${word}"
    done
